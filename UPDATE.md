...
| Nova instância falha mesmo sem probes do updater | o helper podia ser criado enquanto o TailMsg antigo ainda mantinha os sockets abertos, prolongando o handoff | parar o `NetworkService` antes de criar o helper; em caso de falha, reiniciar o serviço na instância antiga |
